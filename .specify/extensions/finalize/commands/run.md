---
description: Cierra una feature después de la implementación — estado de PRs multi-repo, verificación atestiguada por el usuario de tareas dependientes de infraestructura, limpieza de branches y reporte de cierre.
scripts:
...
Corre `{SCRIPT}` desde la raíz del repo `loopi-specs-v2`.
