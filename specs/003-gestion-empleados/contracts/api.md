...
| 422 | `email_invalido` | `email` no tiene formato de dirección de correo válido |
| 422 | `fecha_nacimiento_invalida` | `fecha_nacimiento` no tiene formato YYYY-MM-DD |
| 422 | `edad_minima_requerida` | La fecha de nacimiento corresponde a una persona menor de 18 años |
